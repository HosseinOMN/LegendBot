...
```
bash <(curl -s https://raw.githubusercontent.com/HosseinOMN/LegendBot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/HosseinOMN/LegendBot/main/update.sh)
```
